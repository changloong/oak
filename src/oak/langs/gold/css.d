...
private {
	...
	static const SymbolRule[50] RuleTable = [ 
		 { 0, 48, [44,48,] , "<StyleSheet> ::= <Style> <StyleSheet> "}, 
		 { 1, 48, [] , "<StyleSheet> ::= "}, 
		 { 2, 44, [46,22,40,23,] , "<Style> ::= <Style ID List> { <Attributes> } "}, 
		 { 3, 46, [47,9,46,] , "<Style ID List> ::= <Style IDs> , <Style ID List> "}, 
		 { 4, 46, [47,] , "<Style ID List> ::= <Style IDs> "}, 
		 { 5, 47, [45,47,] , "<Style IDs> ::= <Style ID> <Style IDs> "}, 
		 { 6, 47, [45,] , "<Style IDs> ::= <Style ID> "}, 
		 { 7, 45, [29,] , "<Style ID> ::= ID "}, 
		 { 8, 45, [29,43,] , "<Style ID> ::= ID <Pseudo Class> "}, 
		 { 9, 45, [24,] , "<Style ID> ::= ClassID "}, 
		 { 10, 45, [24,43,] , "<Style ID> ::= ClassID <Pseudo Class> "}, 
		 { 11, 40, [39,40,] , "<Attributes> ::= <Attribute> <Attributes> "}, 
		 { 12, 40, [] , "<Attributes> ::= "}, 
		 { 13, 39, [37,10,38,17,] , "<Attribute> ::= <Attrib ID List> : <Attrib Values> ; "}, 
		 { 14, 37, [29,9,37,] , "<Attrib ID List> ::= ID , <Attrib ID List> "}, 
		 { 15, 37, [29,] , "<Attrib ID List> ::= ID "}, 
		 { 16, 38, [51,41,9,38,] , "<Attrib Values> ::= <Values> <Important Opt> , <Attrib Values> "}, 
		 { 17, 38, [51,41,] , "<Attrib Values> ::= <Values> <Important Opt> "}, 
		 { 18, 51, [50,51,] , "<Values> ::= <Value> <Values> "}, 
		 { 19, 51, [50,] , "<Values> ::= <Value> "}, 
		 { 20, 50, [32,] , "<Value> ::= Number "}, 
		 { 21, 50, [32,49,] , "<Value> ::= Number <Unit> "}, 
		 { 22, 50, [29,] , "<Value> ::= ID "}, 
		 { 23, 50, [36,] , "<Value> ::= StringLiteral "}, 
		 { 24, 50, [26,] , "<Value> ::= ColorRGB "}, 
		 { 25, 50, [29,7,42,8,] , "<Value> ::= ID ( <Params> ) "}, 
		 { 26, 50, [29,7,8,] , "<Value> ::= ID ( ) "}, 
		 { 27, 42, [50,9,42,] , "<Params> ::= <Value> , <Params> "}, 
		 { 28, 42, [50,] , "<Params> ::= <Value> "}, 
		 { 29, 49, [27,] , "<Unit> ::= em "}, 
		 { 30, 49, [28,] , "<Unit> ::= ex "}, 
		 { 31, 49, [35,] , "<Unit> ::= px "}, 
		 { 32, 49, [6,] , "<Unit> ::= % "}, 
		 ...
		 { 36, 49, [34,] , "<Unit> ::= pt "}, 
		 { 37, 49, [33,] , "<Unit> ::= pc "}, 
		 { 38, 41, [5,] , "<Important Opt> ::= !important "}, 
		 { 39, 41, [] , "<Important Opt> ::= "}, 
		 { 40, 43, [11,] , "<Pseudo Class> ::= :active "}, 
		 { 41, 43, [12,] , "<Pseudo Class> ::= :first-letter "}, 
		 { 42, 43, [13,] , "<Pseudo Class> ::= :first-line "}, 
		 { 43, 43, [14,] , "<Pseudo Class> ::= :hover "}, 
		 { 44, 43, [15,] , "<Pseudo Class> ::= :link "}, 
		 { 45, 43, [16,] , "<Pseudo Class> ::= :visited "}, 
		 { 46, 43, [19,] , "<Pseudo Class> ::= @font-face "}, 
		 { 47, 43, [21,] , "<Pseudo Class> ::= @media "}, 
		 { 48, 43, [18,] , "<Pseudo Class> ::= @charset "}, 
		 { 49, 43, [20,] , "<Pseudo Class> ::= @import "}, 
	]; 
